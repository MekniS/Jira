...
LABEL maintainer="Mekni <Mekni.cld@gmail.com>" version="9.11.2"
...
&& curl -o ${AGENT_PATH}/${AGENT_FILENAME}  https://github.com/MekniS/Jira/tree/main/atlassian-agent/v${AGENT_VERSION}/atlassian-agent.jar -L \
...
&& curl -o ${JIRA_INSTALL}/lib/mysql-connector-java-${MYSQL_DRIVER_VERSION}.jar https://repo1.maven.org/maven2/com/mysql/mysql-connector-j/${MYSQL_DRIVER_VERSION}/mysql-connector-java-${MYSQL_DRIVER_VERSION}.jar -L \
